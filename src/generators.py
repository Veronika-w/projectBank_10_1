...
def filter_by_currency(transactions: list[Dict], currency: str) -> Iterator[Dict]:
    ...
    for transact in transactions:
        if transact["operationAmount"]["currency"]["name"] == currency:
            yield transact
...
if __name__ == "__main__":
    gen = filter_by_currency(list_transactions, currency="USD")
    for i in range(3):
        print(next(gen))
...
result = card_number_generator(0, 9999999999999999)
